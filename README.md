...
1. Use `xeCJK`(for `XeLaTeX`) or `luatex-ja`(for `LuaLaTeX`) to better handle Chinese character. Since it use UTF-8 as only means of encoding, it has more comparability with other package.
...
**Important : This template can only be compiled by XeTeX or LuaTeX.**
...
* Manual: See [hustthesis.pdf](https://github.com/michael911009/HUSTThesis/blob/master/doc/hustthesis.pdf).
