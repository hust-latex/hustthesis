...
本模板为华中科技大学\textbf{非官方}学术论文模板。希望能够帮助正忙于撰写毕业论文和学术论文的华科学子。并且我们希望借助这个模板在学校内推广\LaTeX{}的使用。此模板为个人开发，如果因为使用这份模板蒙受了任何经济、学术上的损失，作者将不承担任何责任。
...
本模板基于原有的\href{http://sourceforge.net/projects/hustthesis}{\texttt{HUSTPHDthesis.cls}  (2006/04/06 V2.0)}重写而成，并以LPPL v1.3为协议发布于\href{https://github.com/michael911009/HUSTThesis}{GitHub}上。
...
\lstinputlisting[language={[LaTeX]TeX},firstline=34]{../hustthesis/hust-thesis-var.tex}
