...
\begin{itemize}
    ...
    \item \href{http://mirrors.ctan.org/help/Catalogue/entries/xy.html}{\texttt{xy}} 用于绘制简单图形。如需更高级功能可以使用\href{http://mirrors.ctan.org/help/Catalogue/entries/tikz.html}{\texttt{tikz}}宏包。
...
\begin{lstlisting}[language={[LaTeX]TeX},breaklines=true]
